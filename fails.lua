...
UckfupAuras = {
	...
	[GetSpellInfo(62039)] = {boss = L["Hodir"], stacks = 3, throttle = 10},
	-- Flash Freeze
	[GetSpellInfo(61969)] = {boss = L["Hodir"], throttle = 10},
}
...
UckfupSpells = {
	...
	[GetSpellInfo(64733)] = {boss = L["Razorscale"], event = "SPELL_DAMAGE"},
	...
	[GetSpellInfo(62681)] = {boss = L["Ignis the Furnace Master"], event = "SPELL_INTERRUPT"},
	...
	[GetSpellInfo(32857)] = {boss = L["Iron Council"], event = "SPELL_DAMAGE", mob = 32857},
	...
	[GetSpellInfo(63976)] = {boss = L["Kologarn"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(62457)] = {boss = L["Hodir"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(62466)] = {boss = L["Thorim"], event = "SPELL_DAMAGE", mob = 32865},
	...
	[GetSpellInfo(62465)] = {boss = L["Thorim"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(62451)] = {boss = L["Freya"], event = "SPELL_PERIODIC_DAMAGE", hits = 2},
	...
	[GetSpellInfo(62659)] = {boss = L["Freya"], event = "SPELL_DISPEL"},
	...
	[GetSpellInfo(62932)] = {boss = L["Freya"], event = "SPELL_INTERRUPT"},
	...
	[GetSpellInfo(63041)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE"},
	...
	[GetSpellInfo(63293)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(63631)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE"},
	...
	[GetSpellInfo(63009)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE", mob = 34362},
	...
	[GetSpellInfo(63801)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE", mob = 33836, secondMob = 34192}, 
	...
	[GetSpellInfo(64566)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(64875)] = {boss = L["Mimiron"], event = "SPELL_DAMAGE"},
	...
	[GetSpellInfo(63337)] = {boss = L["General Vezax"], event = "SPELL_ENERGIZE", threshold = 12800},
	...
	[GetSpellInfo(62659)] = {boss = L["General Vezax"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(63884)] = {boss = L["Yogg-Saron"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(63803)] = {boss = L["Yogg-Saron"], event = "SPELL_DAMAGE", threshold = 1800, throttle = 10},
	...
	[GetSpellInfo(27812)] = {boss = L["Sartharion"], event = "SPELL_DAMAGE", throttle = 5},
	...
	[GetSpellInfo(57491)] = {boss = L["Flame Tsunami"], event = "SPELL_DAMAGE", throttle = 10},
	...
	[GetSpellInfo(29371)] = {boss = L["Heigan"], event = "SPELL_DAMAGE", throttle = 5},
}
