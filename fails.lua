...
UckfupSpells = {
	...
	-- Devouring Flames / 4/28 19:52:13.198  SPELL_DAMAGE,0x0000000000000000,nil,0x80000000,0x05000000027ED384,"Shinen",0x514,64733,"Devouring Flame",0x4,9471,0,4,1002,0,0,nil,nil,nil
	...
	-- Flames (Mimron Hard) / 5/21 21:21:08.993 SPELL_DAMAGE,0x0000000000000000,nil,0x80000000,0x0380000001F43F45,"Rubu",0x511,64566,"Flames",0x4,7204,0,4,2110,0,0,nil,nil,nil
	[GetSpellInfo(64566)] = {type = "SPELL_DAMAGE", throttle = 5},
	-- Shadow Fissure (Sarth) / 1/26 17:21:58.706 SPELL_DAMAGE,0xF130003F01003E54,"Shadow Fissure",0xa48,0xF130005E8F003E3D,"Army of the Dead Ghoul",0x2114,27812,"Void Blast",0x20,135642,130121,32,0,0,0,nil,nil,nil
	[GetSpellInfo(27812)] = {type = "SPELL_DAMAGE", throttle = 5},
	-- Flame Tsunami (Sarth) / 1/26 18:07:33.731 SPELL_DAMAGE,0xF130007798003120,"Flame Tsunami",0xa48,0xF1406356CD000162,"Dirtleaper",0x1114,57491,"Flame Tsunami",0x4,1800,0,4,0,0,0,nil,nil,nil
	[GetSpellInfo(57491)] = {type = "SPELL_DAMAGE", throttle = 10},
	-- Eruption (Heigan) / 3/12 18:30:31.857 SPELL_DAMAGE,0xF11002C514000083,"Plague Fissure",0x4228,0xF140609B60000041,"Momofuku",0x1114,29371,"Eruption",0x8,1728,0,8,0,0,0,nil,nil,nil
