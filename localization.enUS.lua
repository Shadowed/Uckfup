UckfupLocals = {
	...
	["/fail report <channel> - Channel to report to, supports RAID/PARTY/SAY/GUILD/OFFICER/Channel name/Chat frame #"] = "/fail report <channel> - Channel to report to, supports RAID/PARTY/SAY/GUILD/OFFICER/Channel name/Chat frame #",
